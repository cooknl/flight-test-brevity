...
For the United States armed forces, brevity codes are defined in the document *BREVITY* [@8379642/A99Q8MZZ]. The publicly releasable version of the document is used for this guide.
...
Properly used, brevity can assist flight test conduct by encouraging proper communication. There is loose correlation between proper communications and test conduct quality, as shown in @tbl-correlation.
