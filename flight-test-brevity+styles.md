...
|                      |                      | flight or test.      |
+----------------------+----------------------+----------------------+
| NO JOY\*             | Aircrew does not     | Similar to BLIND,    |
...
|                      | affecting the        | typically different  |
...
![](media/image2.png){width="6.5in" height="4.446166885389326in"}
...
|             | ansmissions | Paragraph"} | Paragraph"} | Paragraph"} |
|             | to allow    |             |     > The   |             |
...
+-------------+-------------+-------------+-------------+-------------+
| "\[INCREASE | Per the     | -   ::      | -   ::      | -   ::      |
| /DECREASE\] | brief and   | : {custom-s | : {custom-s | : {custom-s |
| \[P         | the mission | tyle="List  | tyle="List  | tyle="List  |
| ARAMETER\]" | materials,  | Paragraph"} | Paragraph"} | Paragraph"} |
|             | the         |     > "     |             |     > "Your |
|             | parameter   | CHECK/WATCH |   > Aircrew |     > \[    |
|             | is about to |     > \[P   |             | PARAMETER\] |
|             | go out of   | ARAMETER\]" |   > doesn't |     > is    |
|             | toler       |     :::     |     > know  |     >       |
|             | ance/limits |             |     > what  | approaching |
|             | unless you  | -   ::      |     > you   |     >       |
|             | comply with | : {custom-s |     > want  |  \[TOLERANC |
|             | this        | tyle="List  |     > after | E/LIMIT\]." |
|             | advisory    | Paragraph"} |     > they  |     :::     |
|             | call.       |     > "..." |     > look  |             |
|             |             |     >       |     > at    | -   ::      |
|             |             |  (crickets) |     > the   | : {custom-s |
|             |             |     :::     |     >       | tyle="List  |
|             |             |             |  parameter. | Paragraph"} |
|             |             |             |     > The   |     > Say   |
|             |             |             |             |             |
...
|             |             |             |     :::     |             |
+-------------+-------------+-------------+-------------+-------------+
| "TERMINATE" | Per the     | -   ::      | > Confusion | -   ::      |
|             | brief and   | : {custom-s |             | : {custom-s |
| "ABORT"     | the mission | tyle="List  |             | tyle="List  |
|             | materials,  | Paragraph"} |             | Paragraph"} |
| "KN         | stop what   |     > Not   |             |             |
| OCK-IT-OFF" | you're      |             |             |   > Because |
|             | doing and   |  > reacting |             |     > of    |
| Ex.         | take        |     > per   |             |     > the   |
|             | corrective  |     > the   |             |             |
| Project:    | action.     |     > brief |             |    > urgent |
| \"Quell     |             |     :::     |             |             |
| Terminate\" |             |             |             |    > nature |
|             |             | -   ::      |             |     > of    |
| Quell 1:    |             | : {custom-s |             |     > these |
| \"Quell 1   |             | tyle="List  |             |             |
| Terminate\" |             | Paragraph"} |             |    > calls, |
|             |             |     > The   |             |     > it's  |
| Quell 2:    |             |     >       |             |             |
| \"Quell 2   |             |  originator |             |    > better |
| Terminate\" |             |     > not   |             |     > to    |
|             |             |             |             |     > say   |
| Project:    |             |    > saying |             |     > the   |
| \"Project   |             |     > the   |             |     > wrong |
...
+-------------+-------------+-------------+-------------+-------------+
| "POINT      | The test    | -   ::      | -   ::      | -   ::      |
| COMPLETE"   | point was   | : {custom-s | : {custom-s | : {custom-s |
|             | executed    | tyle="List  | tyle="List  | tyle="List  |
|             | within the  | Paragraph"} | Paragraph"} | Paragraph"} |
|             | success     |             |             |             |
|             | criteria    |    > Saying |    > Either |  > "Standby |
|             | per the     |             |             |     > while |
|             | brief and   |    > "POINT |    > you're |     > we    |
|             | mission     |             |     > lucky |     > look  |
|             | materials   | > COMPLETE" |     > and   |     > at    |
|             |             |             |     > the   |     > the   |
|             |             |    > before |     > point |             |
|             |             |     > you   |     > was   |    > data." |
|             |             |     > know  |             |     :::     |
...
|             |             | > COMPLETE" |     > the   | -   ::      |
|             |             |             |     > point | : {custom-s |
|             |             |    > before |     > was   | tyle="List  |
|             |             |     > the   |     > not,  | Paragraph"} |
|             |             |             |     > in    |     > "     |
|             |             |  > maneuver |     > fact, | Mach/airspe |
|             |             |             |             | ed/altitude |
|             |             |    > and/or | > complete. |     > out   |
|             |             |             |     :::     |     > of    |
|             |             |  > recovery |             |     >       |
|             |             |     > are   | -   ::      | parameters. |
|             |             |             | : {custom-s |     > We'll |
|             |             | > finished. | tyle="List  |     > need  |
|             |             |     :::     | Paragraph"} |     > to    |
|             |             |             |     > The   |             |
|             |             | -   ::      |             |    > repeat |
|             |             | : {custom-s |   > aircrew |     > that  |
|             |             | tyle="List  |     > cease |             |
|             |             | Paragraph"} |     > test  |   > point." |
|             |             |             |     > point |     :::     |
|             |             |    > Saying |             |             |
|             |             |             | > execution | -   ::      |
|             |             |    > "POINT |     > prior | : {custom-s |
|             |             |             |     > to    | tyle="List  |
|             |             | > COMPLETE" |     >       | Paragraph"} |
|             |             |     > when  | completion, |     > "The  |
|             |             |     > what  |             |             |
|             |             |     > you   |  > negating |   > control |
|             |             |             |     > the   |     > room  |
|             |             |    > really |     > data  |     > is    |
|             |             |     > mean  |     > and   |             |
|             |             |     > is    |             | > satisfied |
...
+-------------+-------------+-------------+-------------+-------------+
| "MISSION    | The data,   | -   ::      | -   ::      | -   ::      |
| COMPLETE"   | fuel,       | : {custom-s | : {custom-s | : {custom-s |
|             | aircraft,   | tyle="List  | tyle="List  | tyle="List  |
|             | or          | Paragraph"} | Paragraph"} | Paragraph"} |
|             | formation   |     > "..." |             |     > Say   |
|             | requires    |     >       |   > Aircrew |             |
|             | that the    |  (crickets) |     > ask   |   > somethi |
|             | test        |     > or    |     >       | ng/anything |
|             | portion of  |             |  questions, |     :::     |
|             | the mission | > generally |             |             |
|             | must        |             |    > trying | -   ::      |
|             | conclude.   |    > succes |     > to    | : {custom-s |
|             |             | s-ambiguous |             | tyle="List  |
|             |             |     > comm  | > determine | Paragraph"} |
|             |             |     :::     |     > if    |     > "The  |
|             |             |             |     > the   |             |
|             |             | -   ::      |             |   > control |
|             |             | : {custom-s |   > mission |     > room  |
|             |             | tyle="List  |     > is    |     > shows |
|             |             | Paragraph"} |     > going |     > there |
|             |             |             |     > to    |     > is no |
|             |             |  > "CLEARED |             |     > more  |
|             |             |     > TO    |  > continue |             |
|             |             |     > RTB"  |     > or    |   > testing |
...
[^1]: ::: {custom-style="footnote text"}
    []{custom-style="footnote reference"}
    [[http://www.dtic.mil/cgi-bin/GetTRDoc?Location=U2&doc=GetTRDoc.pdf&AD=ADA404426]{custom-style="Hyperlink"}](http://www.dtic.mil/cgi-bin/GetTRDoc?Location=U2&doc=GetTRDoc.pdf&AD=ADA404426)
    :::
